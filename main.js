...
var $author$project$Main$Model = F3(
	function (searchName, searchResult, draftedCards) {
...
var $author$project$Main$cardInfoDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$CardInfo,
...
var $author$project$Main$modelDecoder = A4(
	...
	A2($elm$json$Json$Decode$field, 'searchName', $elm$json$Json$Decode$string),
	A2(
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		function () {
			var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$modelDecoder, flags);
			if (_v0.$ === 'Ok') {
				var model = _v0.a;
				var _v1 = A2($elm$core$Debug$log, 'success in flags decoding', flags);
				return model;
			} else {
				var err = _v0.a;
				var _v2 = A2($elm$core$Debug$log, 'decode error', err);
				return {draftedCards: _List_Nil, searchName: '', searchResult: _List_Nil};
			}
		}(),
...
var $author$project$Main$encodeCardInfo = function (cardInfo) {
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'searchName',
				$elm$json$Json$Encode$string(model.searchName)),
				_Utils_Tuple2(
				'searchResult',
...
var $author$project$Main$GotCardList = function (a) {
	return {$: 'GotCardList', a: a};
};
var $author$project$Main$cardsListDecoder = A2(
	$elm$json$Json$Decode$field,
	'cards',
	$elm$json$Json$Decode$list($author$project$Main$cardInfoDecoder));
...
var $author$project$Main$cardsUrlByName = function (name) {
	return A3(
...
var $author$project$Main$getCardListFromName = function (name) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotCardList, $author$project$Main$cardsListDecoder),
			url: $author$project$Main$cardsUrlByName(name)
		});
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								searchResult: $author$project$Main$unique(cardList)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
			...
			case 'GotSearchName':
				var name = msg.a;
				var resp = ($elm$core$String$length(name) > 4) ? $author$project$Main$getCardListFromName(name) : $elm$core$Platform$Cmd$none;
				var _v3 = A2($elm$core$Debug$log, 'search name', name);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{searchName: name}),
...
var $author$project$Main$GotSearchName = function (a) {
	return {$: 'GotSearchName', a: a};
};
var $author$project$Style$PrimaryDark = {$: 'PrimaryDark'};
...
var $author$project$Main$getManaCostList = function (cardInfo) {
	var res = A2(
		...
		$elm$core$String$toList(
			A2($elm$core$Maybe$withDefault, '', cardInfo.manaCost)));
	var _v0 = A2($elm$core$Debug$log, 'res', res);
	return res;
};
var $author$project$Style$MainText = {$: 'MainText'};
...
var $author$project$Style$Fallback = {$: 'Fallback'};
var $author$project$Style$Headline = {$: 'Headline'};
var $author$project$Style$PrimaryLight = {$: 'PrimaryLight'};
var $author$project$Style$PrimarySans = {$: 'PrimarySans'};
var $author$project$Style$Yellow = {$: 'Yellow'};
...
var $author$project$Style$colorPaletteToColor = function (color) {
	switch (color.$) {
		...
		case 'PrimaryDark':
			return A4($mdgriffith$elm_ui$Element$rgba255, 45, 45, 42, 1);
		case 'PrimaryLight':
			return A4($mdgriffith$elm_ui$Element$rgba255, 200, 200, 200, 1);
		case 'SecondaryDark':
			return A4($mdgriffith$elm_ui$Element$rgba255, 76, 76, 71, 1);
		case 'Red':
...
var $author$project$Style$fontStack = function (font) {
	switch (font.$) {
		case 'Headline':
			return $mdgriffith$elm_ui$Element$Font$external(
				{name: 'dosis', url: 'https://fonts.googleapis.com/css?family=Dosis'});
		case 'PrimarySans':
			return $mdgriffith$elm_ui$Element$Font$external(
				{name: 'roboto', url: 'https://fonts.googleapis.com/css?family=Roboto'});
		case 'SecondarySans':
			return $mdgriffith$elm_ui$Element$Font$sansSerif;
		case 'PrimarySerif':
			return $mdgriffith$elm_ui$Element$Font$external(
				{name: 'esteban', url: 'https://fonts.googleapis.com/css?family=Esteban'});
		case 'SecondarySerif':
			return $mdgriffith$elm_ui$Element$Font$serif;
		default:
			return $mdgriffith$elm_ui$Element$Font$sansSerif;
	}
};
...
var $author$project$Style$styling = function (style) {
	switch (style.$) {
		case 'Header':
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Style$fontStack($author$project$Style$Headline),
							$author$project$Style$fontStack($author$project$Style$Fallback)
						]))
				]);
		case 'Subheader':
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Style$fontStack($author$project$Style$PrimarySans),
							$author$project$Style$fontStack($author$project$Style$Headline),
							$author$project$Style$fontStack($author$project$Style$Fallback)
						]))
				]);
...
var $author$project$Main$mainText = function (val) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		$author$project$Style$styling($author$project$Style$MainText),
...
var $author$project$Icons$circle = function (color) {
	var size = '20';
	var rad = '8';
	var pos = '10';
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Style$colorPaletteToHex(color)),
...
var $author$project$Style$MtgBlack = {$: 'MtgBlack'};
var $author$project$Style$MtgBlue = {$: 'MtgBlue'};
var $author$project$Style$MtgGreen = {$: 'MtgGreen'};
var $author$project$Style$MtgRed = {$: 'MtgRed'};
var $author$project$Style$MtgWhite = {$: 'MtgWhite'};
var $elm$core$Debug$todo = _Debug_todo;
var $author$project$Main$letterToColor = function (_char) {
	var _v0 = A2($elm$core$Debug$log, 'char', _char);
	switch (_char.valueOf()) {
		case 'W':
			return $author$project$Style$MtgWhite;
		case 'U':
			return $author$project$Style$MtgBlue;
		case 'B':
			return $author$project$Style$MtgBlack;
		case 'G':
			return $author$project$Style$MtgGreen;
		case 'R':
			return $author$project$Style$MtgRed;
		default:
			return _Debug_todo(
				'Main',
				{
...
var $author$project$Main$manaIcon = function (_char) {
	var html = $elm$core$Char$isDigit(_char) ? $mdgriffith$elm_ui$Element$html(
		$author$project$Icons$toHtml(
			$author$project$Icons$numberedCircle(
				A2(
					$elm$core$Maybe$withDefault,
					0,
					$elm$core$String$toInt(
						$elm$core$String$fromChar(_char)))))) : $mdgriffith$elm_ui$Element$html(
		$author$project$Icons$toHtml(
			$author$project$Icons$circle(
				$author$project$Main$letterToColor(_char))));
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$author$project$Main$getManaCostList(card)))
			]));
};
...
var $author$project$Main$cardNameButton = function (card) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_Nil,
		{
			label: $author$project$Main$mainText(card.name),
			onPress: $elm$core$Maybe$Just(
				$author$project$Main$SelectCard(card))
		});
};
...
var $author$project$Style$Header = {$: 'Header'};
var $author$project$Main$h1 = function (val) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
						...
						[
								...
								[
										...
										]),
									{
										label: A2(
											...
											_List_Nil,
											$author$project$Main$mainText('Search')),
										onChange: $author$project$Main$GotSearchName,
										placeholder: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
												$author$project$Main$mainText('type more than 4 chars'))),
									...
									A2($elm$core$List$map, $author$project$Main$cardNameButton, model.searchResult))
								])),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									A2($elm$core$List$map, $author$project$Main$cardDisplay, model.draftedCards))
								]))
						]))
				])));
};
